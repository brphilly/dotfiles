...
return {
	...
	LspDiagnosticsUnderlineError = {sp = c.error, att = 'undercurl'},
	LspDiagnosticsUnderlineWarning = {sp = c.warning, att = 'undercurl'},
	LspDiagnosticsUnderlineInformation = {sp = c.info, att = 'undercurl'},
	LspDiagnosticsUnderlineHint = {sp = c.hint, att = 'undercurl'},
