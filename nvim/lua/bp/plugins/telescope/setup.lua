...
skeymap("n", "<leader>ff<leader>", maps .. "files_cwd()<cr>", { noremap = true })
...
skeymap("n", "<leader>fs<leader>", maps .. "grep_cwd()<cr>", { noremap = true })
...
skeymap("n", "<leader>ft<leader>", maps .. "grep_todo_cwd()<cr>", { noremap = true })
