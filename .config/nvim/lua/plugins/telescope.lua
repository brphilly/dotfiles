return {
	...
	},
	{
		...
		init = function()
			...
			vim.keymap.set("n", "<leader>fF", function() require("telescope.builtin").buffers() end)
			...
			vim.keymap.set("n", "<leader>fH", function() require("telescope.builtin").man_pages() end)
			vim.keymap.set("n", "<leader>fq", function() require("telescope.builtin").quickfixhistory() end)
			vim.keymap.set("n", "<leader>F", function() require("telescope.builtin").resume() end)
		end,
		config = function()
