...
return function()
	...
	vim.api.nvim_set_hl(0, "@strong", {bold = true})
	vim.api.nvim_set_hl(0, "@emphasis", {italic = true})
	vim.api.nvim_set_hl(0, "@underline", {undercurl = true})
	vim.api.nvim_set_hl(0, "@strike", {strikethrough = true})
	vim.api.nvim_set_hl(0, "@math", {link = "Comment"})
	vim.api.nvim_set_hl(0, "@text.reference", {fg = c.info})
	vim.api.nvim_set_hl(0, "@environment", {link = "@text"})
	vim.api.nvim_set_hl(0, "@environment.name", {link = "@type"})
	vim.api.nvim_set_hl(0, "@title", {link = "Title"})
	vim.api.nvim_set_hl(0, "@literal", {link = "@text"})
	vim.api.nvim_set_hl(0, "@uri", {link = "Underlined"})

	vim.api.nvim_set_hl(0, "@comment", {link = "Comment"})
	vim.api.nvim_set_hl(0, "@note", {fg = c.note})
	vim.api.nvim_set_hl(0, "@warning", {fg = c.warning})
	vim.api.nvim_set_hl(0, "@danger", {fg = c.danger})
